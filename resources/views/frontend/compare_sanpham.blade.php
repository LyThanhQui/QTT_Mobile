		...
		<table class="table table-bordered text-center">
			<tbody>
				<tr class="pr_image">
					...
					<td class="row_img"><img src="{{env('APP_URL') . '/storage/app/' .$sp1->hinhanh}}" alt="compare-img"></td>
					<td class="row_img"><img src="{{env('APP_URL') . '/storage/app/' .$sp2->hinhanh}}"></td>

				</tr>
				<tr class="pr_title">
					<td class="row_title">Tên sản phẩm</td>
					<td class="product_name"><a href="shop-product-detail.html">{{$sp1->tensanpham}}</a></td>
					<td class="product_name"><a href="shop-product-detail.html">{{$sp2->tensanpham}}</a></td>
				...
				<tr class="pr_rating">
					...
					<td>
						<div class="rating_wrap">
							...
							<span class="rating_num">{{ number_format($sp1->dongia * 1.1) }}<sup>đ</sup></span>
						</div>
					</td>
					<td>
						<div class="rating_wrap">

							<span class="rating_num">{{ number_format($sp2->dongia * 1.1) }}<sup>đ</sup></span>
						</div>
					</td>
