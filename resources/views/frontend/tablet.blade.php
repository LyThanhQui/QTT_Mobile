						...
						<div class="col-lg-3 col-md-4 col-6">
							<div class="product">
								<div class="product_img">
									<a href="{{ route('frontend.detail', ['id' => $value->id]) }}">
								...
								<div class="product_info">
									<h6 class="product_title"><a href="shop-product-detail.html">{{ $value->tensanpham }}</a></h6>
									<div class="product_price">
										<span class="price">{{ number_format($value->dongia * 1.1) }}<sup>đ</sup></span>
										<del>{{ number_format($value->dongia) }}<sup>đ</sup></del>
										<div class="on_sale">
											<span>10% Off</span>
										</div>
									</div>
