							...
							<table class="table">
								...
								<tbody>
									@foreach(Cart::content() as $value)
										<tr>
											<td class="product-thumbnail"><a href="#"><img src="{{ env('APP_URL') . '/storage/app/' . $value->options->image }}" alt="product1"></a></td>
											...
											<td class="product-subtotal" data-title="Total">{{ number_format($value->price * $value->qty) }}</td>
