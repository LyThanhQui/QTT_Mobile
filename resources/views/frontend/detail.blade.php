					...
					<div class="col-lg-6 col-md-6 mb-4 mb-md-0">
						<div class="product-image">
							<div class="product_img_box">
								<img id="product_img" src="{{env('APP_URL') . '/storage/app/' .$sanpham->hinhanh}}" data-zoom-image="assets/images/product_zoom_img1.jpg" alt="product_img1" />
							...
							<div id="pr_item_gallery" class="product_gallery_item slick_slider" data-slides-to-show="4" data-slides-to-scroll="1" data-infinite="false">
								<div class="item">
									<a href="#" class="product_gallery_item active" data-image="assets/images/product_img1.jpg" data-zoom-image="assets/images/product_zoom_img1.jpg">
										<img src="{{env('APP_URL') . '/storage/app/' .$sanpham->hinhanh}}" alt="product_small_img1" />
									</a>
								</div>
								<div class="item">
									<a href="#" class="product_gallery_item" data-image="assets/images/product_img1-2.jpg" data-zoom-image="assets/images/product_zoom_img2.jpg">
										<img src="{{env('APP_URL') . '/storage/app/' .$sanpham->hinhanh}}" alt="product_small_img2" />
									</a>
								</div>
								<div class="item">
									<a href="#" class="product_gallery_item" data-image="assets/images/product_img1-3.jpg" data-zoom-image="assets/images/product_zoom_img3.jpg">
										<img src="{{env('APP_URL') . '/storage/app/' .$sanpham->hinhanh}}" alt="product_small_img3" />
									</a>
								</div>
								<div class="item">
									<a href="#" class="product_gallery_item" data-image="assets/images/product_img1-4.jpg" data-zoom-image="assets/images/product_zoom_img4.jpg">
										<img src="{{env('APP_URL') . '/storage/app/' .$sanpham->hinhanh}}" alt="product_small_img4" />
									</a>
								</div>
								<div class="item">
									<a href="#" class="product_gallery_item" data-image="assets/images/product_img1-2.jpg" data-zoom-image="assets/images/product_zoom_img2.jpg">
					...
					<div class="col-lg-6 col-md-6">
						<div class="pr_detail">
							<div class="product_description">
								<h4 class="product_title"><a href="#">{{$sanpham->tensanpham}}</a></h4>
								<div class="product_price">
									<span class="price">{{ number_format($sanpham->dongia ) }}<sup>đ</sup></span>
									<del>{{ number_format($sanpham->dongia * 1.1) }}<sup>đ</sup></del>
									<div class="on_sale">
										<span>10% Off</span>
									</div>
								</div>
							...
							<div class="cart_extra">
								...
								<div class="cart_btn">
									<button class="btn btn-fill-out btn-addtocart" type="button"><i class="icon-basket-loaded"></i><a href="{{ route('frontend.giohang.them', ['tensanpham_slug' => $sanpham->tensanpham_slug]) }}"> Add to cart</a></button>
						...
						<div class="tab-style3">
							...
							<div class="tab-content shop_info_tab">
								...
								<div class="tab-pane fade" id="Reviews" role="tabpanel" aria-labelledby="Reviews-tab">
									<div class="comments">
										<h5 class="product_tab_title">Có 2 đánh giá cho sản phẩm <span>{{$sanpham->tensanpham}}</span></h5>
										<ul class="list_none comment_list mt-4">
											<li>
												<div class="comment_img">
													<img src="{{ env('APP_URL') . '/storage/app/user/LyThanhQui.JPG'}}" alt="user1" />
												</div>
											...
											<li>
												<div class="comment_img">
													<img src="{{ env('APP_URL') . '/storage/app/user/thai-thanh.jpg'}}" alt="user2" />
												</div>
												<div class="comment_block">
													<div class="rating_wrap">
														<div class="rating">
						...
						<div class="releted_product_slider carousel_slider owl-carousel owl-theme" data-margin="20" data-responsive='{"0":{"items": "1"}, "481":{"items": "2"}, "768":{"items": "3"}, "1199":{"items": "4"}}'>
							<div class="item">
								<div class="product">
									<div class="product_img">
										<a href="#">
											<img src="{{env('APP_URL') . '/storage/app/' .$sp1->hinhanh}}" alt="product_img1">
										</a>
										<div class="product_action_box">
											<ul class="list_none pr_action_btn">
												<li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
												<li><a href="{{ route('frontend.compare', ['id' => $sanpham->id,  'id1' => $sp1->id]) }}"><i class="icon-shuffle"></i></a></li>
									...
									<div class="product_info">
										<h6 class="product_title"><a href="shop-product-detail.html">{{$sp1->tensanpham}}</a></h6>
										<div class="product_price">
											<span class="price">{{ number_format($sp1->dongia * 1.1) }}<sup>đ</sup></span>
											<del>{{ number_format($sp1->dongia) }}<sup>đ</sup></del>
											<div class="on_sale">
												<span>35% Off</span>
											</div>
										</div>
								...
								<div class="product">
									<div class="product_img">
										<a href="shop-product-detail.html">
											<img src="{{env('APP_URL') . '/storage/app/' .$sp2->hinhanh}}" alt="product_img2">
										</a>
										<div class="product_action_box">
											<ul class="list_none pr_action_btn">
												<li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
												<li><a href="{{ route('frontend.compare', ['id' => $sanpham->id,  'id1' => $sp2->id]) }}"><i class="icon-shuffle"></i></a></li>
									...
									<div class="product_info">
										<h6 class="product_title"><a href="shop-product-detail.html">{{$sp2->tensanpham}}</a></h6>
										<div class="product_price">
											<span class="price">{{ number_format($sp2->dongia * 1.1) }}<sup>đ</sup></span>
											<del>{{ number_format($sp2->dongia) }}<sup>đ</sup></del>
											<div class="on_sale">
												<span>25% Off</span>
											</div>
										</div>
							...
							<div class="item">
								<div class="product">
									...
									<div class="product_img">
										<a href="shop-product-detail.html">
											<img src="{{env('APP_URL') . '/storage/app/' .$sp3->hinhanh}}" alt="product_img3">
										</a>
										<div class="product_action_box">
											<ul class="list_none pr_action_btn">
												<li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
												<li><a href="{{ route('frontend.compare', ['id' => $sanpham->id,  'id1' => $sp3->id]) }}"><i class="icon-shuffle"></i></a></li>
												<li><a href="shop-quick-view.html" class="popup-ajax"><i class="icon-magnifier-add"></i></a></li>
												<li><a href="#"><i class="icon-heart"></i></a></li>
											</ul>
										</div>
									...
									<div class="product_info">
										<h6 class="product_title"><a href="shop-product-detail.html">{{$sp3->tensanpham}}</a></h6>
										<div class="product_price">
											<span class="price">{{ number_format($sp3->dongia * 1.1) }}<sup>đ</sup></span>
											<del>{{ number_format($sp3->dongia) }}<sup>đ</sup></del>
										</div>
										<div class="rating_wrap">
											<div class="rating">
							...
							<div class="item">
								<div class="product">
									<div class="product_img">
										<a href="shop-product-detail.html">
											<img src="{{env('APP_URL') . '/storage/app/' .$sp4->hinhanh}}" alt="product_img4">
										</a>
										<div class="product_action_box">
											<ul class="list_none pr_action_btn">
												<li class="add-to-cart"><a href="#"><i class="icon-basket-loaded"></i> Add To Cart</a></li>
												<li><a href="{{ route('frontend.compare', ['id' => $sanpham->id,  'id1' => $sp4->id]) }}"><i class="icon-shuffle"></i></a></li>
												<li><a href="shop-quick-view.html" class="popup-ajax"><i class="icon-magnifier-add"></i></a></li>
												<li><a href="#"><i class="icon-heart"></i></a></li>
											</ul>
										</div>
									...
									<div class="product_info">
										<h6 class="product_title"><a href="shop-product-detail.html">{{$sp4->tensanpham}}</a></h6>
										<div class="product_price">
											<span class="price">{{ number_format($sp4->dongia * 1.1) }}<sup>đ</sup></span>
											<del>{{ number_format($sp4->dongia) }}<sup>đ</sup></del>
											<div class="on_sale">
												<span>20% Off</span>
											</div>
										</div>
