			...
			<div class="container">
				<nav class="navbar navbar-expand-lg">
					<a class="navbar-brand" href="{{ route('frontend') }}">
						<img class="logo_light" src="{{ asset('public/assets/images/smartphone.png') }}" />
					...
					<div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
						<ul class="navbar-nav">
							...
							<li><a class="nav-link nav_item" href="{{ route('frontend') }}">Điện Thoại</a></li>
							<li><a class="nav-link nav_item" href="{{ route('frontend.laptop') }}">Laptop</a></li>
							<li><a class="nav-link nav_item" href="{{ route('frontend.tablet') }}">Máy Tính Bảng</a></li>
					...
					<ul class="navbar-nav attr-nav align-items-center">
						...
						<li class="dropdown cart_dropdown">
							<a class="nav-link cart_trigger" href="#" data-toggle="dropdown"><i class="linearicons-cart"></i><span class="cart_count">{{ Cart::count() }}</span></a>
							@if(Cart::count() > 0)
							<div class="cart_box dropdown-menu dropdown-menu-right">
								...
								<div class="cart_footer">
									<p class="cart_total"><strong>Tổng tiền sản phẩm:</strong> <span class="cart_price">{{ Cart::priceTotal() }}
