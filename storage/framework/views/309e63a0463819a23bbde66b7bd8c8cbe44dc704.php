									...
									<div class="custom_select">
										<form action="<?php echo e(route('frontend.sanpham')); ?>" method="post">
											...
											<select class="form-control form-control-sm" id="sapxep" name="sapxep" onchange="if(this.value != 0) { this.form.submit(); }">
												...
												<option value="popularity" <?php echo e(session('sapxep') == 'popularity' ? 'selected' : ''); ?>>Mua nhiều nhất</option>
												<option value="date" <?php echo e(session('sapxep') == 'date' ? 'selected' : ''); ?>>Hàng mới nhất</option>
												<option value="price" <?php echo e(session('sapxep') == 'price' ? 'selected' : ''); ?>>Xếp theo giá: thấp đến cao</option>
												<option value="price-desc" <?php echo e(session('sapxep') == 'price-desc' ? 'selected' : ''); ?>>Xếp theo giá: cao xuống thấp</option>
											</select>
										</form>
									</div>
								</div>
						...
						<div class="col-lg-3 col-md-4 col-6">
							<div class="product">
								<div class="product_img">
									<a href="<?php echo e(route('frontend.detail', ['id' => $value->id])); ?>">
									...
									<div class="product_action_box">
										<ul class="list_none pr_action_btn">
											...
											<li><a href="<?php echo e(route('frontend.quickview', ['id' => $value->id])); ?>" class="popup-ajax"><i class="icon-magnifier-add"></i></a></li>
											<li><a href="#"><i class="icon-heart"></i></a></li>
										</ul>
									</div>
								</div>
								<div class="product_info">
									<h6 class="product_title"><a href="shop-product-detail.html"><?php echo e($value->tensanpham); ?></a></h6>
...
<?php echo $__env->make('layouts.frontend', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\QTT_Mobile\resources\views/frontend/index.blade.php ENDPATH**/ ?>