...
<div class="card">
	...
	<div class="card-body">
		<form action="<?php echo e(route('sanpham.sua', ['id' => $sanpham->id])); ?>" method="post">
			<?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\wamp64\www\QTT_Mobile\resources\views/sanpham/sua.blade.php ENDPATH**/ ?>